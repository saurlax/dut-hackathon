...
- 报名与队伍资料在明确同意公开后立即展示；管理员会不定期巡查并下架违规资料。找队友卡片可打开完整公开资料，公开范围包括姓名、学校/学院/年级、校内身份、报名方式、能力与角色意向、合作安排、经历、简介、作品集和参赛者主动填写的公开联系方式；手机号、联系邮箱和学号等核验信息不会公开。最终确认与作品仍需要审核通过后展示。
